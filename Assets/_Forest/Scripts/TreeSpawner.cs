...
public class TreeSpawner : MonoBehaviour
{
    ...
    public static List<GameObject> TreesTemp = new List<GameObject>();
    ...
    public void TreeSpawn()
    {
        for(int i = 0;i<=2000;i++)
        {
            ...
            TreesTemp.Add(Instantiate<GameObject>(Trees[RandomTree], new Vector3(PosX, 0, PosZ), Quaternion.identity));   
        }       
    }
}
